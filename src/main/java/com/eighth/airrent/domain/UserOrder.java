...
public class UserOrder extends BaseDomain {
	...
	// 支付状态 ONLINE_PAYED线上已支付 OFFLINE_PAYED线下已支付 NOT_PAY_ONLINE 线上未支付
	// NOT_PAY_OFFLINE线下未支付
	private String orderStatus;
	private String description;// 备注
	private String orderCreateByTime;
	...
	public String getOrderCreateByTime() {
		return orderCreateByTime;
	}

	public void setOrderCreateByTime(String orderCreateByTime) {
		this.orderCreateByTime = orderCreateByTime;
	}
