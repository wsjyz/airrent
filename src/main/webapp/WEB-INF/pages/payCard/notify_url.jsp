...
<%@page import="com.eighth.airrent.proxy.service.OrderPayRelService"%>
...
<%
	...
	if(AlipayNotify.verifyNotify(params)){//验证成功
		...
		OrderPayRelService orderService = (OrderPayRelService) ctx.getBean("OrderPayRelService");
		OrderPayRel orderPayRel=orderService.findOrderByOrderNum(out_trade_no);
